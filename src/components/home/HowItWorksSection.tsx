...
export function HowItWorksSection() {
  return (
    <section className="bg-white px-4 py-16">
      ...
      <div className="container mx-auto flex flex-col items-center justify-center gap-6 sm:flex-row">
        {steps.map(({ title, description, icon: Icon }, index) => (
          <div key={index} className="flex items-center">
            {/* Step card */}
            <div className="flex w-64 flex-col items-center rounded-xl border border-primary/20 bg-primary/5 px-6 py-8 text-center transition hover:shadow-lg">
