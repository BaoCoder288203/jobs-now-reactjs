...
export interface AdminAnalyticsDateFilterValue {
...
interface AdminAnalyticsDateFilterProps {
  value: AdminAnalyticsDateFilterValue;
  onChange: (next: AdminAnalyticsDateFilterValue) => void;
}
...
export function AdminAnalyticsDateFilter({ value, onChange }: AdminAnalyticsDateFilterProps) {
  const setPreset = (preset: AdminDashboardPreset) => {
